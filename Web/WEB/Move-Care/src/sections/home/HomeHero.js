...
// routes
import { PATH_DASHBOARD,  PATH_LINK_DOWNDOWN} from '../../routes/paths';
// hooks
    ...
    <StyledDescription>
      ...
      <m.div variants={varFade().in}>
        <Typography variant="body4" sx={{ textAlign: 'center' }}>
          Bạn cứ tận hưởng cuộc sống phần còn lại chúng tôi lo
        </Typography>
      </m.div>
